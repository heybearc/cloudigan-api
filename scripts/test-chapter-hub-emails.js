#!/usr/bin/env node
/**
 * Send BNI Chapter Hub test emails (customer + admin). Run on container with M365 .env.
 */
...
const sample = {
  productName: 'BNI Chapter Hub - Medium Chapter',
...
async function main() {
  ...
  await sendPurchaseNotification({
    ...
    ...sample,
    actions,
    serverLabel: 'cloudigan-api (BNI Chapter Hub test)',
  });
