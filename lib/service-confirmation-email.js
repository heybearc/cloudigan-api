        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 600px; max-width: 600px; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 35px;">
              ...
              <p style="margin: 0 0 15px 0; font-size: 15px; line-height: 1.6; color: #2c3e50;">If you have not already spoken with us about your support hours, we will be in touch to coordinate your time and answer any questions about how to use your hours.</p>
              <p style="margin: 0 0 20px 0; font-size: 15px; line-height: 1.6; color: #2c3e50;">Questions or need to share details? Email <a href="mailto:${escapeHtml(supportEmail)}" style="color: #3b82f6; text-decoration: none;">${escapeHtml(supportEmail)}</a> (our help desk and ticketing system). ${escapeHtml(NO_REPLY_NOTE)}</p>
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f0f9ff; border-left: 5px solid #0ea5e9; border-radius: 0 6px 6px 0; padding: 18px; margin: 20px 0;">
                <tr>
                  <td>
                    <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #0c4a6e;">This purchase is for <strong>professional IT support</strong>, not RMM agent software. No download or installation is required on your devices.</p>
                  </td>
                </tr>
              </table>
...
WHAT HAPPENS NEXT
If you have not already spoken with us about your support hours, we will be in touch to coordinate your time and answer any questions about how to use your hours.

Questions or need to share details? Email ${supportEmail} (our help desk and ticketing system). ${NO_REPLY_NOTE}

This purchase is for professional IT support, not RMM agent software. No download or installation is required.
