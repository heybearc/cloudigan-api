...
function buildServiceConfirmationEmail(data) {
  ...
  const supportEmail = data.supportEmail || process.env.SERVICE_SUPPORT_EMAIL || 'hello@cloudigan.com';
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 600px; max-width: 600px; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 35px;">
              ...
              <p style="margin: 0 0 15px 0; font-size: 15px; line-height: 1.6; color: #2c3e50;">A member of our team will reach out within <strong>one business day</strong> to coordinate your support time and answer any questions about how to use your hours.</p>
              <p style="margin: 0 0 20px 0; font-size: 15px; line-height: 1.6; color: #2c3e50;">If you need to share context before we call, reply to this email or contact us at <a href="mailto:${escapeHtml(supportEmail)}" style="color: #3b82f6; text-decoration: none;">${escapeHtml(supportEmail)}</a>.</p>
...
WHAT HAPPENS NEXT
A member of our team will reach out within one business day to coordinate your support time.

If you need to share context before we call, reply to this email or contact us at ${supportEmail}.
