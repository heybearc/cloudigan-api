...
const CHAPTER_HUB_KEYWORDS = ['chapter hub'];
...
const PROFILES = {
  ...
  service: {
    ...
    notApplicableNote:
      'No RMM provisioning for this product — Datto site, agent downloads, welcome email, and Wix CMS were not used.',
  },
  'chapter-hub': {
    id: 'chapter-hub',
    categoryLabel: 'Chapter Hub subscription',
    quantityLabel: 'Plan',
    formatProductLine(productName) {
      return productName || 'Chapter Hub';
    },
    adminFields: ['product', 'customer', 'company', 'email', 'amount', 'stripeSession'],
    actionsSectionTitle: 'Processing summary',
    actionLabels: {
      payment_received: 'Stripe payment received and recorded',
      chapter_hub_confirmation: 'Chapter Hub welcome email sent to customer',
      admin_notification: 'Admin notification sent',
    },
    notApplicableNote:
      'No RMM provisioning for this product — Datto site, agent downloads, Home Protect welcome email, and Wix CMS were not used.',
  },
};
